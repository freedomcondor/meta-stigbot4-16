...
static const struct reg_value ov5640_init_setting_30fps_VGA[] = {
	...
	{0x300e, 0x45, 0, 0}, {0x302e, 0x08, 0, 0}, {0x4300, 0x3f, 0, 0},
								...
								//{0x300e, 0x05, 0, 0}, {0x302e, 0x08, 0, 0}, {0x4300, 0x3f, 0, 0},
								//{0x300e, 0x25, 0, 0}, {0x302e, 0x08, 0, 0}, {0x4300, 0x3f, 0, 0},
	
	{0x501f, 0x00, 0, 0}, {0x4713, 0x03, 0, 0}, {0x4407, 0x04, 0, 0},
	{0x440e, 0x00, 0, 0}, {0x460b, 0x35, 0, 0}, {0x460c, 0x22, 0, 0},
	{0x4837, 0x0a, 0, 0}, {0x4800, 0x04, 0, 0}, {0x3824, 0x02, 0, 0},
	
								//{0x4837, 0x0a, 0, 0}, {0x4800, 0x14, 0, 0}, {0x3824, 0x02, 0, 0},
	
								//{0x4837, 48, 0, 0}, {0x4800, 0x04, 0, 0}, {0x3824, 0x02, 0, 0},
								//{0x4837, 24, 0, 0}, {0x4800, 0x04, 0, 0}, {0x3824, 0x02, 0, 0},
								//{0x4837, 24, 0, 0}, {0x4800, 0x14, 0, 0}, {0x3824, 0x02, 0, 0},
								//{0x4837, 12, 0, 0}, {0x4800, 0x04, 0, 0}, {0x3824, 0x02, 0, 0},
								//{0x4837, 6, 0, 0}, {0x4800, 0x04, 0, 0}, {0x3824, 0x02, 0, 0},
								
								//{0x4837, 21, 0, 0}, {0x4800, 0x04, 0, 0}, {0x3824, 0x02, 0, 0},
								
								//{0x4837, 12, 0, 0}, {0x4800, 0x14, 0, 0}, {0x3824, 0x02, 0, 0},
								//{0x4837, 0x05, 0, 0}, {0x4800, 0x04, 0, 0}, {0x3824, 0x02, 0, 0},
										// no int
								//{0x4800, 0x04, 0, 0}, {0x3824, 0x02, 0, 0},
										// l3
								//{0x4837, 0x14, 0, 0}, {0x4800, 0x04, 0, 0}, {0x3824, 0x02, 0, 0},
										// l3
								//{0x4837, 0x28, 0, 0}, {0x4800, 0x04, 0, 0}, {0x3824, 0x02, 0, 0},
										// l3
								//{0x4837, 0x10, 0, 0}, {0x4800, 0x04, 0, 0}, {0x3824, 0x02, 0, 0},
										// l3
								//{0x4837, 0x22, 0, 0}, {0x4800, 0x04, 0, 0}, {0x3824, 0x02, 0, 0},
								//{0x4837, 0x0b, 0, 0}, {0x4800, 0x04, 0, 0}, {0x3824, 0x02, 0, 0},
								//{0x4837, 0x36, 0, 0}, {0x4800, 0x04, 0, 0}, {0x3824, 0x02, 0, 0},
...
static const struct reg_value ov5640_setting_30fps_720P_1280_720[] = {
	...
	{0x380b, 0xd0, 0, 0}, {0x380c, 0x07, 0, 0}, {0x380d, 0x64, 0, 0},
		...
		//{0x380b, 0xbc, 0, 0}, {0x380c, 0x07, 0, 0}, {0x380d, 0x64, 0, 0},
...
static int harrydebug_reg_print(	struct ov5640_dev *sensor, 
									...
									int size)
{
	...
	for (i = 0; i < size; i++)
	{
		ret = ov5640_read_reg(sensor, reglist[i].reg, &val);
		if (val != reglist[i].val)
			pr_err("{ 0x%x, 0x%x }, ---- different! old: 0x%x\n",reglist[i].reg,val,reglist[i].val);
		else
			pr_err("{ 0x%x, 0x%x },\n",reglist[i].reg,val);
	}
	return 0;
...
static int ov5640_set_stream_mipi(struct ov5640_dev *sensor, bool on)
{
	int ret;
									...
									/*
									pr_err("i am set_stream_mipi\n");
									u8 val;
									ret = ov5640_read_reg(sensor, OV5640_REG_FORMAT_CONTROL00,&val);
										pr_err("i am stream mipi, fmt = %d\n",val);
									pr_err("------start to dump regs----------\n");
										harrydebug_reg_print(sensor,configscript_common1,34);
									pr_err("---------------------------------\n");
										harrydebug_reg_print(sensor,configscript_common2,77);
									pr_err("------end of dump regs----------\n");
									*/
...
static int ov5640_get_pclk(struct ov5640_dev *sensor)
{
	u32 xvclk = sensor->xclk_freq;
	u32 multiplier, prediv, VCO, sysdiv, mipidiv;
	u32 pclk;
	u8 temp1, temp2;
	int ret;
...
static int ov5640_get_sysclk(struct ov5640_dev *sensor)
{
	...
	//if (temp2 == 8 || temp2 == 10)
	//	bit_div2x = temp2 / 2;
	ret = ov5640_read_reg(sensor, OV5640_REG_IO_MIPI_CTRL00, &temp1);
	if (temp2 == 8 || temp2 == 10)
		if (temp1 == 0x05)
			bit_div2x = temp2;
		else
	...
	VCO = xvclk * multiplier / prediv;
											...
											pr_err("in getsysclk: multiplier = %d\n",multiplier);
												pr_err("in getsysclk: prediv = %d\n",prediv);

	sysclk = VCO / sysdiv / pll_rdiv * 2 / bit_div2x / sclk_rdiv;

												pr_err("in getsysclk: sysdiv = %d\n",sysdiv);
												pr_err("in getsysclk: pll_rdiv = %d\n",pll_rdiv);
												pr_err("in getsysclk: bit_div2x = %d\n",bit_div2x);
												pr_err("in getsysclk: sclk_rdiv = %d\n",sclk_rdiv);
			  ...
			  struct v4l2_subdev_format *format)
{
	...
	int ret;
										...
										pr_err("i am set fmt\n");
										pr_err("i am set fmt code = %x\n",format->format.code);
									pr_err("i am set uyvy code = %x\n",MEDIA_BUS_FMT_UYVY8_1X16);
...
static int ov5640_init_controls(struct ov5640_dev *sensor)
{
	...
	ctrls->pixel_rate = v4l2_ctrl_new_std(hdl, ops, V4L2_CID_PIXEL_RATE,
				       0, INT_MAX, 1, ov5640_get_pclk(sensor) / 16);
	ov5640_set_power_off(sensor);
...
static int ov5640_s_stream(struct v4l2_subdev *sd, int enable)
{
	...
	int ret = 0;
													...
													pr_err("i am s_stream enable = %d\n",enable);

	mutex_lock(&sensor->lock);

	if (sensor->streaming == !enable) {
													pr_err("pending mode = %s\n",sensor->pending_mode_change ? "true" : "false");
													pr_err("pending mode = %d\n",sensor->pending_mode_change);
		...
		if (enable) {
			...
			if (ret)
				goto out;
													...
													pr_err("i am s_stream before set framefmt\n");
